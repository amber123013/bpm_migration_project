package com.zefu.ssoa.module.bpm.service.category;

import com.zefu.ssoa.framework.common.enums.CommonStatusEnum;
import com.zefu.ssoa.framework.common.pojo.PageResult;
import com.zefu.ssoa.framework.test.core.ut.BaseDbUnitTest;
import com.zefu.ssoa.module.bpm.controller.admin.definition.vo.category.BpmCategoryPageReqVO;
import com.zefu.ssoa.module.bpm.controller.admin.definition.vo.category.BpmCategorySaveReqVO;
import com.zefu.ssoa.module.bpm.dal.dataobject.definition.BpmCategoryDO;
import com.zefu.ssoa.module.bpm.dal.mysql.category.BpmCategoryMapper;
import com.zefu.ssoa.module.bpm.service.definition.BpmCategoryServiceImpl;
...
import static com.zefu.ssoa.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.zefu.ssoa.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.zefu.ssoa.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.zefu.ssoa.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.zefu.ssoa.framework.test.core.util.AssertUtils.assertServiceException;
import static com.zefu.ssoa.framework.test.core.util.RandomUtils.*;
import static com.zefu.ssoa.module.bpm.enums.ErrorCodeConstants.CATEGORY_NOT_EXISTS;
