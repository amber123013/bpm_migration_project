package com.zefu.ssoa.module.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import com.zefu.ssoa.framework.common.util.collection.SetUtils;
import com.zefu.ssoa.module.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        ...
        // 参见 https://gitee.com/zhijiantianya/ssoa-cloud/issues/IC239F
