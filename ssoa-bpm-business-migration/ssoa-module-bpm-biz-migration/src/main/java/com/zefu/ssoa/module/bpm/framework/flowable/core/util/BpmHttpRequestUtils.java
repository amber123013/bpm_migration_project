...
import com.zefu.ssoa.framework.common.core.KeyValue;
import com.zefu.ssoa.framework.common.pojo.CommonResult;
import com.zefu.ssoa.framework.common.util.json.JsonUtils;
import com.zefu.ssoa.framework.common.util.spring.SpringUtils;
import com.zefu.ssoa.framework.tenant.core.context.TenantContextHolder;
...
import com.zefu.ssoa.module.bpm.enums.definition.BpmHttpRequestParamTypeEnum;
...
import static com.zefu.ssoa.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
import static com.zefu.ssoa.module.bpm.enums.ErrorCodeConstants.PROCESS_INSTANCE_HTTP_CALL_ERROR;
