package com.zefu.ssoa.module.bpm.service.task;
...
import com.zefu.ssoa.framework.common.util.json.JsonUtils;
import com.zefu.ssoa.framework.common.util.object.ObjectUtils;
import com.zefu.ssoa.framework.common.util.object.PageUtils;
import com.zefu.ssoa.framework.datapermission.core.annotation.DataPermission;
import com.zefu.ssoa.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.zefu.ssoa.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.zefu.ssoa.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.zefu.ssoa.module.bpm.controller.admin.task.vo.instance.*;
import com.zefu.ssoa.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.zefu.ssoa.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.zefu.ssoa.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.zefu.ssoa.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.zefu.ssoa.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.zefu.ssoa.module.bpm.enums.ErrorCodeConstants;
import com.zefu.ssoa.module.bpm.enums.definition.BpmModelTypeEnum;
import com.zefu.ssoa.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.zefu.ssoa.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.zefu.ssoa.module.bpm.enums.task.BpmReasonEnum;
import com.zefu.ssoa.module.bpm.enums.task.BpmTaskStatusEnum;
import com.zefu.ssoa.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
...
import com.zefu.ssoa.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.zefu.ssoa.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.zefu.ssoa.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
...
import com.zefu.ssoa.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.zefu.ssoa.module.bpm.service.definition.BpmProcessDefinitionService;
import com.zefu.ssoa.module.bpm.service.message.BpmMessageService;
...
import static com.zefu.ssoa.framework.common.exception.util.ServiceExceptionUtil.exception;
import static com.zefu.ssoa.framework.common.util.collection.CollectionUtils.*;
import static com.zefu.ssoa.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.zefu.ssoa.module.bpm.enums.ErrorCodeConstants.*;
import static com.zefu.ssoa.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.zefu.ssoa.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/ssoa-cloud/issues/ID1UYA
